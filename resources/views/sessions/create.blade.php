...
<x-layout>
    ...
    <x-slot name="content">
        <section class="pt-12 pb-8 bg-lightblue">
                <div
                    class="flex flex-col md:flex-row mx-auto p-4 w-[80vw] bg-white rounded-lg border border-gray-200 shadow-md sm:p-6 lg:p-8 dark:bg-gray-800 dark:border-gray-700">
                    ...
                    <form class="space-y-6 p-4 md:p-8" action="/login" method="POST">
                      @csrf
                        ...
                        <div>
                            <label for="email"
                                class="block text-sm font-medium text-gray-900 dark:text-gray-300">Your
                                email</label>
