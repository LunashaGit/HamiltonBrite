             ...
             <article class="bg-silver-blue mt-16 mb-8 mx-12 rounded-xl relative">
                     ...
                     <div class="font-black tracking-wider">
                         ...
                         <div id="select-container"
                             class="flex flex-wrap text-sm justify-center py-4 px-2 md:px-24 mt-4">
                         ...
                         <div class="flex items-center px-8 mx-auto pb-6 md:px-16 justify-left">
                             <form class="" method="GET" action="/">
                                 <div class="form-group">
                                     <input type="text"
                                         class="justify-center m-2 text-center border-2 border-solid rounded-lg md:p-1 w-36 md:w-64 border-lightblue"
                     ...
                     <div class="flex flex-col pb-24 mr-6 rounded-tr-xl rounded-br-xl bg-newgrey sm:mr-12">
                         ...
                         <div
                             ...
                             @foreach ($posts as $post)
                                 <div
                                     class="xl:max-w-[1280px] text-sm pb-6 w-56 mx-auto text-black rounded-xl cursor-pointer sm:w-64 overflow-hidden z-2 hover:scale-110 card hover:bg-gray-700 hover:text-whitesmoke hover:duration-300 bg-whitesmoke">
                         ...
                         <a class="{{ $loop->even ? 'Even' : 'No' }}" href="/posts/<?= $post->slug ?>">
                             ...
                             <div class="flex flex-col w-full">
                                 ...
                                 <div class="flex flex-col place-content-end">
                                     ...
                                     <div class="flex pl-4 pb-1 text-left "><svg xmlns="http://www.w3.org/2000/svg"
