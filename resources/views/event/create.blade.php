<x-layout>
    ...
    <x-slot name="content">
        <section class="flex flex-col pb-24 text-left pt-36 bg-littlegrey dark:bg-silver">
            <div>
                <div
                    class="flex flex-col md:flex-row mx-auto max-w-[80vw] xl:max-w-[60rem] rounded-lg shadow-md p-2 sm:p-4 md:p-6 lg:p-8 text-whitesmoke bg-gray-700 dark:bg-gray-800 ">
                    <div class="flex float-left ">
                        <div
                            class="flex-row rounded-lg bg-whitesmoke md:max-w-xl hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
                    ...
                    <form class="flex flex-col justify-around p-4 md:p-8" action="/event" method="POST"
                        ...
                        <input
                            ...
                            autocomplete="off" type="text" nam0e="title" id="title" placeholder="Title of post"
                            required>
                        <label for="address"
                        ...
                        <div class="relative flex "><input
                                ...
                                class="h-5 w-5 flex absolute right-[5%] top-[20%] hover:scale-120" viewBox="0 0 20 20" fill="currentColor">
                        ...
                        <div class="">
                            ...
                            <label
                                ...
                                <input class="hidden" type="file" id="image" onchange="showPreview(event)"
                                    ...
                                    class="flex float-right mr-1 w-[1.15rem] h-[1.15rem] hover:scale-120" viewBox="0 0 20 20"
                                    fill="white">
                                    <path fill-rule="evenodd"
