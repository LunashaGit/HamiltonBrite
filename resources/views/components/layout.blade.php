...
<nav class="p-5 bg-whitesmoke text-black shadow md:flex md:items-center md:justify-between">
    ...
    <ul class="burger-links md:flex text-black md:items-center z-[500] md:static absolute bg-whitesmoke w-full left-0 md:w-auto md:py-0 py-4 md:pl-0 pl-7 md:opacity-100 opacity-0 top-[-400px] transition-all ease-in duration-500">
